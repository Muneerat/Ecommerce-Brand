...
export default function Featured({ img, header, text }) {
  return (
    <div className="text-center flex flex-col items-center p-5 hover:-translate-y-4 duration-300 transition-all dark:text-white dark:shadow-md dark:shadow-slate-50">
