        ...
        {cart.length < 1 ? (
          <div className="flex justify-center h-[520px] items-center">
            <div className="text-center">
              ...
              <button
                onClick={() => navHome()}
                className="p-1 my-4 transition-all duration-300 bg-primary w-full text-white rounded-md"
              >
                Continue shopping
              </button>
            </div>
          ...
          <div>
            <div className="scroll-x-container flex flex-col gap-y-2 py-4 h-[520px] w-full lg:h-[610px] overflow-auto overflow-scrol border-b">
              <h1 className="text-xl font-semibold">My cart</h1>
              {cart.map((item, index) => {
                return (
                  <div className="shadow-md md:p-3 flex gap-x-4 py-2 lg:px-6 border-b border-gray-200 w-[100vh] md:w-full font-light">
                    <div
                      className="w-full min-w-[10px] min-h-[150px] flex items-center gap-x-4"
                      key={index}
                    >
                      <Link>
                        <img
                      ...
                      <div className="flex flex-col w-full md:ml-4">
                        ...
                        <div className="flex ">
                          ...
                          <h2 className="flex-1 flex items-center justify-around">
                            {item?.price}
                          </h2>
                          <h2 className="flex-1 flex items-center justify-around">
